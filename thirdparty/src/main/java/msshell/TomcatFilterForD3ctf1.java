 ...
 * @since 2023/3/1
 */
public class TomcatFilterForD3ctf1 implements Filter {

    private static String uri;
    private static String filterName = "DefaultFilter";

    private static String data = "test";
    public TomcatFilterForD3ctf1(String uri){
    }

    public TomcatFilterForD3ctf1() {
        try{
            ...
            if (threadLocal != null && threadLocal.get() != null) {
                ...
                TomcatFilterForD3ctf1 filter = new TomcatFilterForD3ctf1(uri);
